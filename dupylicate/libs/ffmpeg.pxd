...
cdef extern from "libavcodec/avcodec.h" nogil:
    ...
    char *avcodec_get_name(AVCodecID id)
    ...
    int av_image_fill_arrays(uint8_t *dst_data[4], int dst_linesize[4], const uint8_t *src, AVPixelFormat pix_fmt, int width, int height, int align)
...
cdef extern from "libswscale/swscale.h" nogil:
    ...
    int sws_scale(SwsContext *c, uint8_t *srcSlice[], int srcStride[], int srcSliceY, int srcSliceH, uint8_t *dst[], int dstStride[])